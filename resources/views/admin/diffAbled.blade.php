...
<script>
  $(document).ready(function() {
    $('#diffAbledTable').DataTable({
        ...
        ajax: {
            url: `{{ url('/admin/application/differently/abled/datatable') }}`,
            type: 'GET',
            dataSrc: 'data',
        },
        columns: [
...
$(document).ready(function() {
    $('#diffAbled').on('submit', function(e) {
        ...
        $.ajax({
            url: `{{ url('admin/application/differently/abled/new') }}`, // Your endpoint
            type: 'POST',
            data: formData,
...
$(document).on('click', '.view-more', function() {
    ...
    if (diffId !== undefined) {
        $.ajax({
            url: `{{ url('/admin/application/differently/abled/view/more') }}/${diffId}`, // Laravel route
            method: 'GET',
            success: function(response) {
...
$(document).on('click', '.edit', function() {
    ...
    $.get(`{{ url('/admin/application/diffabled/edit') }}/${diffAbledId}`, function(data) {
...
$(document).ready(function() {
    $('#EditdiffAbled').on('submit', function(e) {
        ...
        $.ajax({
            ...
            url: "{{ route('admin.UpdateDiffAbled') }}",
            data: formData,
            dataType: 'json',
            beforeSend: function() {
...
$(document).on('click', '.delete', function() {
    ...
    $('#confirmDelete').off('click').on('click', function() {
        $.ajax({
            url: `{{ url('/admin/application/diffabled/delete') }}/${diffId}`,
            type: 'DELETE',
            data: {
                _token: '{{ csrf_token() }}'
            },
