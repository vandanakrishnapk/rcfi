...
<div class="row mt-3">
    <div class="col-12">
        <div class="float-start">
            <a href="{{ route('admin.getProjects')}}" class="btn btn-sm rounded-circle pro"><i class="bi bi-box-arrow-in-left fs-4 ms-1"></i></a>
        </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body widgetcolor1 rounded">
                ...
                <div class="pt-2">
                    <div class="float-end">
                        <a href="{{ route('admin.education')}}" class="text-white"><i class="mdi mdi-arrow-right h5"></i></a>
                    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body widgetcolor1 rounded">
                ...
                <div class="pt-2">
                    <div class="float-end">
                        <a href="{{ route('admin.cultural')}}" class="text-white"><i class="mdi mdi-arrow-right h5"></i></a>
                    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body widgetcolor1 rounded">
                ...
                <div class="pt-2">
                    <div class="float-end">
                        <a href="{{ route('admin.hospital') }}" class="text-white"><i class="mdi mdi-arrow-right h5"></i></a>
                    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body widgetcolor1 rounded">
                ...
                <div class="pt-2">
                    <div class="float-end">
                        <a href="{{ route('admin.shops') }}" class="text-white"><i class="mdi mdi-arrow-right h5"></i></a>
                    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body widgetcolor1 rounded">
                ...
                <div class="pt-2">
                    <div class="float-end">
                        <a href="{{ route('admin.house') }}" class="text-white"><i class="mdi mdi-arrow-right h5"></i></a>
                    </div>
