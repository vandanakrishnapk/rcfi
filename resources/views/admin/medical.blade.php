...
<script>
    ...
    $('#medicalTable').DataTable({
        ...
        ajax: {
            url: `{{ url('/admin/construction/project/medical/datatable') }}`,
            type: 'GET',
            dataSrc: 'data',
        },
        columns: [
...
//submit form
    ...
    $('#medicalForm').on('submit', function(e) {
        ...
        $.ajax({
            url: `{{ url('admin/construction/project/medical/new') }}`, // Your endpoint
            type: 'POST',
            data: formData,
...
$(document).on('click', '.view-more', function() {
    ...
    if (medicalId !== undefined) {
        $.ajax({
            url: `{{ url('/admin/construction/project/medical/view/more') }}/${medicalId}`, // Laravel route
            method: 'GET',
            success: function(response) {
...
$.get(`{{ url('/admin/construction/project/medical/edit') }}/${medicalId}`, function(data) {
...
$(document).on('click', '.delete', function() {
    ...
    $('#confirmDelete').off('click').on('click', function() {
        $.ajax({
            url: `{{ url('/admin/construction/project/medical/delete') }}/${MedicalId}`,
            type: 'DELETE',
            data: {
                _token: '{{ csrf_token() }}'
            },
