...
<script>
    ...
    $('#familyTable').DataTable({
        ...
        ajax: {
            url: `{{ url('/admin/application/family/welfare/datatable') }}`,
            type: 'GET',
            dataSrc: 'data',
        },
        columns: [
    ...
    $('#familyForm').on('submit', function(e) {
        ...
        $.ajax({
            url: `{{ url('admin/application/family/welfare/new') }}`, // Your endpoint
            type: 'POST',
            data: formData,
...
$(document).on('click', '.view-more', function() {
    ...
    if (familyId !== undefined) {
        $.ajax({
            url: `{{ url('/admin/application/family/welfare/view/more') }}/${familyId}`, // Laravel route
            method: 'GET',
            success: function(response) {
...
$(document).on('click', '.edit', function() {
    ...
    $.get(`{{ url('/admin/application/family/welfare/edit/') }}/${familyId}`, function(data) {
...
$(document).on('click', '.delete', function() {
    ...
    $('#confirmDelete').off('click').on('click', function() {
        $.ajax({
            url: `{{ url('/admin/application/family/welfare/delete') }}/${familyId}`,
            type: 'DELETE',
            data: {
                _token: '{{ csrf_token() }}'
            },
