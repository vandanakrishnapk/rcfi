                         ...
                         @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="projectType" name="typeOfProject">
                                    ...
                                    <option value="Markaz Orphan Care">Markaz Orphan Care</option>
                                    ...
                                    <option value="Hospital or Clinics">Hospital or Clinics</option>
...
$(document).ready(function() {
    $('#projectTable').DataTable({
        ...
        dom: 'Bfrtlip',
            ...
            ajax: {
                url: `{{ url('/admin/projects/datatable/orphancare') }}`,
                type: 'GET',
                dataSrc: 'data',
