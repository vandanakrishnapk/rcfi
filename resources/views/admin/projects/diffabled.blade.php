    ...
    $('#projectTable').DataTable({
        ...
        dom: 'Bfrtlip',
            ...
            ajax: {
                ...
                url: `{{ url('/admin/projects/diff/datatable') }}`,
                type: 'POST',
...
$(document).ready(function() {
    $(".submit-project").click(function(e) {
        ...
        $.ajax({
            url: `{{ url('/admin/projects/diff/new') }}`,
            type: "POST",
            data:data,       
            dataType: "JSON",
            processData: false,
...
$(document).on('click', '.view-more', function() {
    ...
    if (ProjectId !== undefined) {
        $.get(`{{ url('/admin/projects/diff/view/more') }}/${ProjectId}`, function(response) {
...
$('#projectTable').on('click', '.edit', function() {
    ...
    $.get(`{{ url('/admin/projects/diff/edit') }}/${projectId}`, function(data) {
...
$(document).ready(function() {
    $('#EditprojectForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            url: "{{ route('admin.updatediffProject') }}",
            data: formData,
            dataType: 'json',
            beforeSend: function() {
...
$(document).on('click', '.delete', function() {
    ...
    $('#confirmDelete').off('click').on('click', function() {
        $.ajax({
            url: `{{ url('/admin/projects/diff/delete') }}/${projectId}`,
            type: 'DELETE',
            data: {
                _token: '{{ csrf_token() }}'
            },
 ...
 $('#fundTable').on('click', '.fund', function() {
        ...
        $.ajax({
            url: `{{ url('/admin/project/diff/fund/view') }}`,  // Adjust this URL as needed
            type: 'GET',
            data: {
    ...
    $.ajax({
        url: `{{ url("/admin/project/diff/fund/new") }}`,  // The URL where the form data will be submitted
        type: 'POST',
        data: formData,
...
$(document).on('click', '.mark', function() {
    ...
    $('#mark').off('click').on('click', function() {
        $.ajax({
            url: `{{ url('/admin/project/diff/status/update') }}/${projectId}`,
            type: 'POST',
            data: {
                _token: '{{ csrf_token() }}'
            },
