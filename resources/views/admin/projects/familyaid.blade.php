    ...
    $('#projectTable').DataTable({
        ...
        dom: 'Bfrtlip',
            ...
            ajax: {
                ...
                url: `{{ url('/admin/projects/family/datatable') }}`,
                type: 'POST',
...
$(document).ready(function() {
    $(".submit-project").click(function(e) {
        ...
        $.ajax({
            url: `{{ url('/admin/projects/family/new') }}`,
            type: "POST",
            data:data,       
            dataType: "JSON",
            processData: false,
...
$(document).on('click', '.view-more', function() {
    ...
    if (ProjectId !== undefined) {
        $.get(`{{ url('/admin/projects/family/view/more') }}/${ProjectId}`, function(response) {
...
$('#projectTable').on('click', '.edit', function() {
    ...
    $.get(`{{ url('/admin/projects/family/edit') }}/${projectId}`, function(data) {
...
$(document).ready(function() {
    $('#EditprojectForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            url: "{{ route('admin.updatefamilyProject') }}",
            data: formData,
            dataType: 'json',
            beforeSend: function() {
...
$(document).on('click', '.delete', function() {
    ...
    $('#confirmDelete').off('click').on('click', function() {
        $.ajax({
            url: `{{ url('/admin/projects/family/delete') }}/${projectId}`,
            type: 'DELETE',
            data: {
                _token: '{{ csrf_token() }}'
            },
 ...
 $('#fundTable').on('click', '.fund', function() {
        ...
        $.ajax({
            url: `{{ url('/admin/project/family/fund/view') }}`,  // Adjust this URL as needed
            type: 'GET',
            data: {
    ...
    $.ajax({
        url: `{{ url("/admin/project/family/fund/new") }}`,  // The URL where the form data will be submitted
        type: 'POST',
        data: formData,
...
$(document).on('click', '.mark', function() {
    ...
    $('#mark').off('click').on('click', function() {
        $.ajax({
            url: `{{ url('/admin/project/family/status/update') }}/${projectId}`,
            type: 'POST',
            data: {
                _token: '{{ csrf_token() }}'
            },
