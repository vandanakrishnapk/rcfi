...
<script>
    ...
    $('#generalTable').DataTable({
        ...
        ajax: {
            url: `{{ url('/admin/application/general/project/datatable') }}`,
            type: 'GET',
            dataSrc: 'data',
        },
        columns: [       
    ...
    $('#apptypeForm').on('submit', function(e) {
        ...
        $.ajax({
            url: `{{ url('/admin/application/general/type/new') }}`,
            type: 'POST',
...
//do general project 
    ...
    $('#generalForm').on('submit', function(e) {
        ...
        $.ajax({
            url: `{{ url('/admin/application/general/project/new') }}`, // Your endpoint
            type: 'POST',
            data: formData,
            success: function(response) {
                toastr.success(response.message, 'Success');
...
$(document).on('click', '.view-more', function() {
    ...
    if (generalId !== undefined) {
        $.ajax({
            url: `{{ url('/admin/application/general/project/view/more/') }}/${generalId}`, // Laravel route
            method: 'GET',
            success: function(response) {
...
$.get(`{{ url('/admin/application/general/project/edit') }}/${generalId}`, function(data) {
...
$(document).on('click', '.delete', function() {
    ...
    $('#confirmDelete').off('click').on('click', function() {
        $.ajax({
            url: `{{ url('/admin/application/general/project/delete/') }}/${generalId}`,
            type: 'DELETE',
            data: {
                _token: '{{ csrf_token() }}'
            },
