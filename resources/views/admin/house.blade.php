...
<script>
    ...
    $('#houseTable').DataTable({
        ...
        ajax: {
            url: `{{ url('/admin/construction/project/house/datatable') }}`,
            type: 'GET',
            dataSrc: 'data',
        },
        columns: [
  ...
  $(document).ready(function() {
    $('#houseForm').on('submit', function(e) {
        ...
        $.ajax({
            url: `{{ url('admin/construction/project/house/new') }}`, // Your endpoint
            type: 'POST',
            data: formData,
...
$(document).on('click', '.view-more', function() {
    ...
    if (houseId !== undefined) {
        $.ajax({
            url: `{{ url('/admin/construction/project/house/view/more') }}/${houseId}`, // Laravel route
            method: 'GET',
            success: function(response) {
...
$.get(`{{ url('/admin/construction/project/house/edit') }}/${houseId}`, function(data) {
...
$(document).on('click', '.delete', function() {
    ...
    $('#confirmDelete').off('click').on('click', function() {
        $.ajax({
            url: `{{ url('/admin/construction/project/house/delete') }}/${houseId}`,
            type: 'DELETE',
            data: {
                _token: '{{ csrf_token() }}'
            },
