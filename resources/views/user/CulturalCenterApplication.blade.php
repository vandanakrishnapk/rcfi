...
$(document).ready(function() {
    $('#CulturalTable').DataTable({
        ...
        ajax: {
            url: `{{ url('user/cultural/centre/application/datatable') }}`,
            type: 'GET',
            dataSrc: 'data',
        },
        columns: [ 
...
$(document).ready(function() {
            $('#CulturalCentreApplication').on('submit', function(e) {
                ...
                $.ajax({
                    url: `{{ url('user/cultural/centre/application/new') }}`,
                    type: 'POST',
                    data: formData,
...
$(document).on('click', '.view-more', function() {
    ...
    if (culturalCentreId !== undefined) {
        $.ajax({
            url: `{{ url('/user/cultural/centre/application/view/more') }}/${culturalCentreId}`, // Laravel route
            method: 'GET',
...
$(document).on('click', '.edit', function() {
    ...
    $.ajax({
        url: `{{ url('/user/cultural/centre/application/edit') }}/${culturalCentreId}`,
        method: 'GET',
        success: function(data) {
...
$(document).ready(function() {
    $('#EditCulturalCentreForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            url:`{{ url('/user/cultural/centre/application/update')}}`,
            data: formData,
            dataType: 'json',
            beforeSend: function() {
...
$(document).on('click', '.delete', function() {
    ...
    $('#confirmDelete').off('click').on('click', function() {
        $.ajax({
            url: `{{ url('/user/cultural/centre/application/delete') }}/${culturalId}`,
            type: 'DELETE',
            data: {
                _token: '{{ csrf_token() }}'
            },
