    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body box rounded">
                ...
                <div class="pt-2">
                    <div class="float-end">
                        <a href="{{ route('user.getMedical') }}" class="text-white"><i class="mdi mdi-arrow-right h5"></i></a>
                    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body box rounded">
                ...
                <div class="pt-2">
                    <div class="float-end">
                        <a href="{{ route('user.getShopAndOthers') }}" class="text-white"><i class="mdi mdi-arrow-right h5"></i></a>
                    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card mini-stat bg-primary text-white">
            <div class="card-body box rounded">
                ...
                <div class="pt-2">
                    <div class="float-end">
                        <a href="{{ route('user.getHouse') }}" class="text-white"><i class="mdi mdi-arrow-right h5"></i></a>
                    </div>
