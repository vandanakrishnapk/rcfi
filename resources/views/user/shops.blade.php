...
$(document).ready(function() {
    $('#shopTable').DataTable({
        ...
        ajax: {
            url: `{{ url('/user/construction/project/shops/others/datatable') }}`,
            type: 'GET',
            dataSrc: 'data',
        },
    columns: [       
    ...
    $('#shopForm').on('submit', function(e) {
        ...
        $.ajax({
            url: `{{ url('/user/construction/project/shops/others/new') }}`, // Your endpoint
            type: 'POST',
            data: formData,
...
$(document).on('click', '.view-more', function() {
    ...
    if (shopId !== undefined) {
        $.ajax({
            url: `{{ url('/user/construction/project/shops/others/view/more') }}/${shopId}`, // Laravel route
            method: 'GET',
            success: function(response) {
...
$.get(`{{ url('/user/construction/project/shops/others/edit') }}/${shopId}`, function(data)
 {
...
$(document).ready(function() {
    $('#EditshopForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            url: "{{ route('user.updateShopAndOther') }}",
            data: formData,
            dataType: 'json',
            beforeSend: function() {
...
$(document).on('click', '.delete', function() {
    ...
    $('#confirmDelete').off('click').on('click', function() {
        $.ajax({
            url: `{{ url('/user/construction/project/shops/others/delete') }}/${shopId}`,
            type: 'DELETE',
            data: {
                _token: '{{ csrf_token() }}'
            },
