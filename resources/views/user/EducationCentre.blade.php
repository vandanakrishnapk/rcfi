            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <h4 class="but p-3 text-center rounded fw-bold border border-success" style="color:white;">EDUCATION CENTRE APPLICATIONS</h4>
...
<script>
    ...
    $('#EducationCentreDataTable').DataTable({
            ...
            ajax: {
                url: `{{ url('/user/education/centre/application/datatable') }}`,
                type: 'GET',
                dataSrc: 'data',
...
$(document).ready(function() {
            $('#EducationCentreApplicationForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: `{{ url('user/education/centre/application/new') }}`,
                    type: 'POST',
                    data: formData,
...
$(document).on('click', '.view-more', function() {
    ...
    if (educationCentreId !== undefined) {
        $.ajax({
            url: `{{ url('/user/education/centre/application/view/more')}}/${educationCentreId}`, // Laravel route
            method: 'GET',
...
$(document).on('click', '.edit', function() {
    ...
    $.get(`{{ url('/user/education/centre/application/edit') }}/${educationCentreId}`, function(data) {
...
$(document).ready(function() {
    $('#EditEducationCentreApplicationForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            url: "{{ route('user.updateEducationCentreApplication') }}",
            data: formData,
            dataType: 'json',
            beforeSend: function() {
...
$(document).on('click', '.delete', function() {
    ...
    $('#confirmDelete').off('click').on('click', function() {
        $.ajax({
            url: `{{ url('/user/education/centre/application/delete') }}/${educationId}`,
            type: 'DELETE',
            data: {
                _token: '{{ csrf_token() }}'
            },
