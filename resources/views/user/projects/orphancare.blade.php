    ...
    $('#projectTable').DataTable({
        ...
        dom: 'Bfrtlip',
            ...
            ajax: {
                ...
                url: `{{ url('/user/projects/odf/datatable') }}`,
                type: 'POST',
                dataSrc: 'data',
...
$(document).on('click', '.view-more', function() {
    ...
    if (ProjectId !== undefined) {
        $.get(`{{ url('/user/projects/odf/view/more') }}/${ProjectId}`, function(response) {
...
$('#projectTable').on('click', '.edit', function() {
    ...
    $.get(`{{ url('/user/projects/odf/edit') }}/${projectId}`, function(data) {
...
$(document).on('click', '.delete', function() {
    ...
    $('#confirmDelete').off('click').on('click', function() {
        $.ajax({
            url: `{{ url('/user/projects/odf/delete') }}/${projectId}`,
            type: 'DELETE',
            data: {
                _token: '{{ csrf_token() }}'
            },
 ...
 $('#fundTable').on('click', '.fund', function() {
        ...
        $.ajax({
            url: `{{ url('/user/project/odf/fund/view') }}`,  // Adjust this URL as needed
            type: 'GET',
            data: {
    ...
    $.ajax({
        url: `{{ url("/user/project/odf/fund/new") }}`,  // The URL where the form data will be submitted
        type: 'POST',
        data: formData,
...
$(document).on('click', '.mark', function() {
    ...
    $('#mark').off('click').on('click', function() {
        $.ajax({
            url: `{{ url('/user/project/odf/status/update') }}/${projectId}`,
            type: 'POST',
            data: {
                _token: '{{ csrf_token() }}'
            },
            success: function(response) {
                ...
                localStorage.setItem('activeTab', '#tab-hoghlights');
            },
            error: function(xhr, status, error) {
                console.error(xhr.responseText);
                toastr.error('Something went wrong!', 'Error', {
...
$(document).on('click', '.paid', function() {
    ...
    $('#paid').off('click').on('click', function() {
        $.ajax({
            url: `{{ url('/user/project/odf/paid/update/') }}/${projectId}`,
            type: 'POST',
            data: {
                _token: '{{ csrf_token() }}'
            },
