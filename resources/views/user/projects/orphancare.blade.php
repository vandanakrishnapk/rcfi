...
<div class="row mt-3">
        ...
        <div class="float-start">
            <a href="{{ route('user.userProject')}}" class="btn pro btn-sm rounded-circle"><i class="bi bi-box-arrow-in-left fs-4 ms-1"></i></a>
        </div>
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <h4 class="widgetcolor p-3 text-center rounded fw-bold border border-success" style="color:white;">MARKAZ ORPHAN CARE PROJECT LIST</h4>
...
$(document).ready(function() {
    $('#projectTable').DataTable({
        ...
        dom: 'Bfrtlip',
            ...
            ajax: {
                url: `{{ url('/user/projects/datatable/orphancare') }}`,
                type: 'GET',
                dataSrc: 'data',
    ...
    render: function(data, type, row, meta) {
        return `
            <div class="dd d-flex">
                         <a href="{{ url('/user/project/details/view') }}/${row.proId}" title="view more" class="btn btn-dark btn-sm ms-1">
                    <i class="bi bi-eye"></i>
                </a>
