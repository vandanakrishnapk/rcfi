            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <h4 class="widgetcolor p-3 text-center rounded fw-bold border border-success" style="color:white;">FAMILY AID PROJECT LIST</h4>
...
$(document).ready(function() {
    $('#projectTable').DataTable({
        ...
        dom: 'Bfrtlip',
            ...
            ajax: {
                url: `{{ url('/user/projects/datatable/familyaid') }}`,
                type: 'GET',
                dataSrc: 'data',
