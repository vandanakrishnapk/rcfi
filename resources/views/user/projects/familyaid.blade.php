                            ...
                            <div class="modal-body p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="application_id">
                                       ...
                                       <option value="{{ $opcares->familyId }}">{{ $opcares->applicationId }}</option>
                                       @endforeach
                                    </select>
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <h4 class="widgetcolor p-3 text-center rounded fw-bold border border-success" style="color:white;">Family Aid</h4>
    ...
    $('#projectTable').DataTable({
        ...
        dom: 'Bfrtlip',
            ...
            ajax: {
                ...
                url: `{{ url('/user/projects/family/datatable') }}`,
                type: 'POST',
...
$(document).ready(function() {
    $(".submit-project").click(function(e) {
        ...
        $.ajax({
            url: `{{ url('/user/projects/family/new') }}`,
            type: "POST",
            data:data,       
            dataType: "JSON",
            processData: false,
...
$(document).on('click', '.view-more', function() {
    ...
    if (ProjectId !== undefined) {
        $.get(`{{ url('/user/projects/family/view/more') }}/${ProjectId}`, function(response) {
...
$('#projectTable').on('click', '.edit', function() {
    ...
    $.get(`{{ url('/user/projects/family/edit') }}/${projectId}`, function(data) {
...
$(document).ready(function() {
    $('#EditprojectForm').on('submit', function(e) {
        ...
        $.ajax({
            ...
            url: "{{ route('user.updatefamilyProject') }}",
            data: formData,
            dataType: 'json',
            beforeSend: function() {
...
$(document).on('click', '.delete', function() {
    ...
    $('#confirmDelete').off('click').on('click', function() {
        $.ajax({
            url: `{{ url('/user/projects/family/delete') }}/${projectId}`,
            type: 'DELETE',
            data: {
                _token: '{{ csrf_token() }}'
            },
 ...
 $('#fundTable').on('click', '.fund', function() {
        ...
        $.ajax({
            url: `{{ url('/user/project/family/fund/view') }}`,  // Adjust this URL as needed
            type: 'GET',
            data: {
    ...
    $.ajax({
        url: `{{ url("/user/project/family/fund/new") }}`,  // The URL where the form data will be submitted
        type: 'POST',
        data: formData,
...
$(document).on('click', '.mark', function() {
    ...
    $('#mark').off('click').on('click', function() {
        $.ajax({
            url: `{{ url('/user/project/family/status/update') }}/${projectId}`,
            type: 'POST',
            data: {
                _token: '{{ csrf_token() }}'
            },
...
$(document).on('click', '.paid', function() {
    ...
    $('#paid').off('click').on('click', function() {
        $.ajax({
            url: `{{ url('/user/project/family/paid/update/') }}/${projectId}`,
            type: 'POST',
            data: {
                _token: '{{ csrf_token() }}'
            },
