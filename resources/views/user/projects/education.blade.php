            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <h4 class="widgetcolor p-3 text-center rounded fw-bold border border-success" style="color:white;">EDUCATION CENTRE PROJECT LIST</h4>
...
$(document).ready(function() {
    $('#projectTable').DataTable({
        ...
        dom: 'Bfrtlip',
            ...
            ajax: {
                url: `{{ url('/user/projects/datatable/education') }}`,
                type: 'GET',
                dataSrc: 'data',
