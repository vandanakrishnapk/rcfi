            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <h4 class="widgetcolor p-3 text-center rounded fw-bold border border-success" style="color:white;">SHOPS AND OTHER PROJECT LIST</h4>
...
$(document).ready(function() {
    $('#projectTable').DataTable({
        ...
        dom: 'Bfrtlip',
            ...
            ajax: {
                url: `{{ url('/user/projects/datatable/shops') }}`,
                type: 'GET',
                dataSrc: 'data',
